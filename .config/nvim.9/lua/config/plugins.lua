	...
	-- Colorschemes
	{
		...
		config = function()
			require("gruvbox").setup({
				...
				contrast = "hard", -- or "soft" or "medium"
			...
			require("dashboard").setup({
				...
				config = {
					...
					center = {
						...
						{ icon = "  ", desc = "Config ", action = "NvimTreeOpen ~/.config/nvim", shortcut = "SPC c" },
						{ icon = "  ", desc = "Store", action = "Store", shortcut = "SPC s" },
						{ icon = "  ", desc = "Clock", action = "TimerlyToggle", shortcut = "SPC T" },
						{ icon = "  ", desc = "Last Session", action = "SessionManager load_last_session", shortcut = "SPC l" },
						{ icon = "󰒲  ", desc = "Lazy", action = "Lazy", shortcut = "SPC L" },
	...
	},
	{
		...
		config = function()
			require("nvim-highlight-colors").setup {
				...
				custom_filetypes = { "rasi", "conf", "text", "mycustomft" }
			}
		end,
	},
